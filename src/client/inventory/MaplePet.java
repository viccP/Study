...
implements Serializable {
    ...
    public static final MaplePet createPet(int itemid, int uniqueid) {
        return MaplePet.createPet(itemid, MapleItemInformationProvider.getInstance().getName(itemid), 1, 0, 100, uniqueid, itemid == 5000054 ? 18000 : 0);
    }
    ...
    public static enum PetFlag {
        ...
        public static final PetFlag getByDelId(int itemId) {
            for (PetFlag flag : PetFlag.values()) {
                if (flag.remove != itemId) continue;
                return flag;
            }
            return null;
        }

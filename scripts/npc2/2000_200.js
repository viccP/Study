...
var ItemId = Array(
		//4000424
	Array(1112277, 1, 4000424, 1112165, "绿光森林聊天"),
        Array(1112272, 1, 4000424, 1112160, "西瓜物语聊天"),
        Array(1112271, 1, 4000424, 1112159, "非洲之星聊天"),
	Array(1112154, 1, 4000424, 1112266, "非洲之星名片")
        //如需其它道具兑换，请按照此格式自行添置。
        //代码,价格,介绍
        );

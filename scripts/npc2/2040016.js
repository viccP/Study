...
function action(mode, type, selection) {
	if (mode == 1)
		...
		cm.dispose();
	if (status == 0 && mode == 1) {
		var selStr = "幫可以幫你做石頭 但是需要一些摳摳.#b"
		var options = new Array("提煉礦物礦石","提煉寶石礦石","提煉罕見寶石","提煉水晶礦石 ","Create materials","Create Arrows");

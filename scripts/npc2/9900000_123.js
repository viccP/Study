...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
             var txt0 = "#L0#" + 红色箭头 + "#b#e冒险生涯任务#n"+感叹号+""+美化new+"#k#l";
            var txt1 = "#L1#" + 蓝色箭头 + "#b每日签到奖励#k#l";
            var txt3 = "#L10##b" + 蓝色箭头 + "充值点券领取";
            var txt4 = "#L6##d" + 蓝色箭头 + "充值礼包领取";
            var txt5 = "#L5##r" + 蓝色箭头 + "查看等级排行"
            var txt6 = "#L4##g" + 蓝色箭头 + "星#r级#d进#b阶#g系#r统"
            var txt8 = "#L8##r" + 蓝色箭头 + "限#d时#g折#b扣#k道#r具#b购#g买\r\n\r\n"
            cm.sendSimple("欢迎来到#b风之大陆....#k有什么可以帮到你的?\r\n\r\n"+ txt0 +"\r\n\r\n" + txt1 + "" + txt6 + "\r\n\r\n" + txt4 + "" + txt5 + "\r\n\r\n" + txt3 + "" + txt8 + "");

        } else if (status == 1) {
            if(selection == 0){
                if(cm.读取任务进度() == 0 && cm.读取任务内容() == 0){
                    //名字  任务ID 任务等级 任务进度
                    cm.主线任务创建(cm.getPlayer().getId(),100,0,0,"#b星缘#k可以帮助你恢复记忆。请去寻找#b星缘 npc#k！");
                    cm.sendOk("--------------------"+cm.任务进度()+"---------------------\r\n"+任务描述+" \r\n\\r\n"+cm.读取任务内容()+"\r\n");
                    cm.dispose();
                }else{
             cm.sendOk("\r\n"+任务描述+" \r\n\\r\n"+cm.读取任务内容()+"\r\n\r\n\r\n--------------------"+cm.任务进度()+"---------------------",2);
         //   cm.主线任务更新内容("#b星缘#k可以帮助你恢复记忆。请去寻找#b星缘 npc#k！");
             cm.dispose();
                }
            }else if (selection == 1) {

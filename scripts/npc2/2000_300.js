...
//4000425
var ItemId = Array(
		Array(1112268, 1, 4000423,1112156, "绿光森林聊天"),
        Array(1112267, 1, 4000423,1112155, "西瓜物语聊天"),
        Array(1112264, 1,  4000423,1112152, "非洲之星聊天"),
		Array(1112265, 1, 4000423,1112153, "压岁钱聊天")
        //如需其它道具兑换，请按照此格式自行添置。
        //代码,价格,介绍
        );
    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            for (var i = 0; i < ItemId.length; i++) {
                StringS += "\r\n#L" + i + "##b#z" + ItemId[i][0] + "##k (需要#r#z " + ItemId[i][2] + " ##kX" + ItemId[i][1] + "个.)";
            }
            ...
            if (zones == 1) {
                ...
                if (cm.getPlayer().getInventory(net.sf.cherry.client.MapleInventoryType.getByType(1)).isFull())
                {
                    ...
                    cm.gainItem(ItemId[selection][0], 1);cm.gainItem(ItemId[selection][3], 1);

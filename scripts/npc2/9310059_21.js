...
/*
 ...
 金币：1亿
 */
var cailiao = "#e\r\n#v4001083#x1,#v4001084#x1,#v4001085#x1,#v4001126#x3000,#v4002002#x10\r\n1亿冒险币#n"
...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            StringS = "#b#n120武器兑换需要的材料为\r\n:" + cailiao + "";
            for (var i = 0; i < ItemId.length; i++) {
                StringS += "\r\n#L" + i + "##b兑换#k【#r#z" + ItemId[i][0] + "##k】#d（道具经验可升级(属性可提升)）";
            }
            ...
            if (zones == 1) {
                ...
                if (cm.getPlayer().getInventory(net.sf.cherry.client.MapleInventoryType.getByType(1)).isFull())
                {
                    ...
                    cm.dispose();
                } else if (cm.haveItem(4001083,1) && cm.haveItem(4001084,1) && cm.haveItem(4001085,1) && cm.haveItem(4001126,3000) && cm.haveItem(4002002,10) && cm.getMeso() >= 100000000) {

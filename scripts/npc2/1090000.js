...
function action(mode, type, selection) {
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if (cm.getJob().equals(510) || cm.getJob().equals(520)) {
				if (cm.getPlayer().getLevel() <= 69) {
					if (cm.getJob().equals(510)) {

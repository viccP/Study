...
//4000425
var ItemId = Array(
		Array(1112254, 1, 4000422,1112143, "绿光森林聊天"),
        Array(1112238, 1, 4000422,1112135, "西瓜物语聊天"),
        Array(1112257, 1, 4000422,1112145,"非洲之星聊天"),
		Array(1112274, 1, 4000422,1112162, "压岁钱聊天")
        //如需其它道具兑换，请按照此格式自行添置。
        //代码,价格,介绍
        );

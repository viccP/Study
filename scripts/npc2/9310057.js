    ...
    if (mode == -1) {
        ...
        if (status == 0) {
            ...
            if (cm.getJob() == 410) {
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：菇菇博士 快速转职成功！");
            } else if (cm.getJob() == 110) {
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：菇菇博士 快速转职成功！");
            } else if (cm.getJob() == 120) {
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：菇菇博士 快速转职成功！");
            ...
            if(cm.getJob() == 1000 && cm.getLevel()>=10){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：菇菇博士 快速转职为骑士团职业！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(parseInt(cm.getJob() / 100) >10 && cm.getLevel()>=30 && cm.getJob()%100 == 0){
            ...
            if(cm.getJob() == 2000 && cm.getLevel() >=10){
                ...
                cm.serverNotice("[转职系统]: 恭喜 [" + cm.getPlayer().getName() + "] 在NPC：菇菇博士 快速转职为战神职业！");
                cm.sendOk("转职成功！加油锻炼，当你变的强大的时候记的来找我哦！");
            } else if(cm.getJob() == 2100 && cm.getLevel() >=30){
                cm.changeJob(2110);

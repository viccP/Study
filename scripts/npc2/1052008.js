...
if (cm.haveItem(4000313, 0)){
                      ...
                      cm.sendOk("謝謝你的支持, 這是給你的#i4032056#1個."); 
                      cm.warp(910000000);
 cm.serverNotice("『忍耐公告』：恭喜"+ cm.getChar().getName() +"，跳過了一號地區忍耐 獲得 1個楓葉水晶!");
                      cm.dispose(); 
            } else { 
                ...
                cm.dispose(); 
                    ...
                    if (cm.haveItem(4000313, 0)) { 
                      ...
                      cm.sendOk("謝謝你的支持!, 這是給你的#i4000313#1個.");
                      cm.warp(910000000); 
 cm.serverNotice("『忍耐公告』：恭喜"+ cm.getChar().getName() +"，跳過了一號地區忍耐 獲得 1個黃金楓葉!");
                      cm.dispose(); 
            } else { 
                cm.sendOk(" #r抱歉. 您帶來的#i4000313#不太夠.#k "); 
                cm.dispose(); 

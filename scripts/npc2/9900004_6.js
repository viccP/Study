...
function action(mode, type, selection) {
    if (mode == -1) {
        ...
        if (mode == 1)
            ...
            status--;
        if (status == 0) {
            var txt1 = " #L1#" + 正方箭头 + " #b合成物理攻击神器#l";
            var txt2 = "#L2#" + 正方箭头 + " #r合成魔法攻击神器#l\r\n\r\n";
            var txt3 = " #L3#" + 正方箭头 + " #g魔舞双修神器<HP MP附加>#l\r\n\r\n";
            var txt4 = "  #L4#" + 正方箭头 + " #d合成#v4000038# >>>>需要六翼天使武器#l\r\n\r\n";
            cm.sendSimple("神器来到了#b枫之梦#k！现在开始，合成神器即可用材料进阶神器等级。神器为：#v1702118# #v1702119#\r\n合成材料为：\r\n#v" + 蓝色蜗牛壳 + "# x 500 。#v" + 时间之石 + "# x 200 。#v4000038# x1 。#v" + 猪头 + "# x 1。\r\n" + txt4 + " " + txt1 + "" + txt2 + " " + txt3 + "");
        } else if (status == 1) {

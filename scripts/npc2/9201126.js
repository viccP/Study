...
if (cm.getChar().getMapId() == 108010501){
    cm.sendSimple ("#b在这里必须要打败BOSS，在他们身上可以获得大量装备，暴率非常搞的哦，不过也要看运气的。您才可以通过\r\n#d剩余G币:#r" + cm.getzb() + "点\r\n【需要1000元宝】 \r\n#L0#挑战巨居蟹#l");
    } else {
...
if (selection == 0) {
	if(cm.getzb() >= 1000) {
            cm.setzb(-1000);
cm.serverNotice("『游戏公告』：玩家【"+ cm.getChar().getName() +"】开始挑战【巨居蟹】！可以获得80-100的装备，新人的天堂哦");  
        cm.summonMob(5220000, 5000000, 10000, 1);//巨居蟹    
        }else{

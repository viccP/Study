	...
	if (mode == -1) {
		...
		if (mode == 1)
			...
			status--;
                                          ...
                                          if (selection == 0){
                                          cm.sendNext(""+name+"是女皇陛下最信赖的部队，他是运用火的属性给敌人造成伤害。等级上限#b"+level+"#k级。\r\n例如技能#b火柱#k，他能用火的力量成为一道光圈，把周围的敌人造成很大的伤害。")
}else if (selection == 1){
status = 2;
cm.sendSimple("你确定好了吗？成为了#p1104101#"+name1+"的部下！？#b\r\n#L0#是的！我无怨无悔成为您的部下！\r\n#L1#不要！让我再想想。。")
}

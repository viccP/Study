	...
	if (mode == -1) {
		...
		if (status == 0) {
			...
			if(finalitem.length != 0){
				...
				if(Laba == 1){
					cm.getC().getChannelServer().getWorldInterface().broadcastMessage(null, net.sf.cherry.tools.MaplePacketCreator.getItemMega(cm.getC().getChannel(),cm.getPlayer().getName() + " : " + "从钓鱼场获得：",toDrop, true).getBytes());
				}
				cm.gainItem(2300000,-1);

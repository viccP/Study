...
function action(mode, type, selection) {
    if (cm.getChar().getInventory(MapleInventoryType.EQUIP).getItem(1) == null) {
        ...
        cm.sendOk("#r#e\r\n#k装备升星条件：\r\n#b装备无继续升级次数\r\n#r开通星级功能\r\n#dPS：使用#g#e【封印之锁 - 30】#n#d可以开通星级功能。商城无法购买该道具，该道具为其他途径获得！");
        cm.dispose();
    } else {
            ...
            if (status == 0) {
                ...
                //      <--------------判断武器是否一致1-3格------------->
                    ...
                    if (cm.getChar().getInventory(MapleInventoryType.EQUIP).getItem(1) != null) {
                        ...
                        add += "\r\n#r强化后综合属性：#k" + paiid;
                        cm.sendNext("#b您当前装备#v" + itemId1 + "#的追加次数为：#k#r(" + item1.getxingji() + "次)#k\r\n#b点击下一项,开始激动人心的追加属性！#k\r\n\r\n" + add);

...
if (cm.haveItem(4031120) && cm.getChar().getMapId() == 674030200){
...
if (selection == 0) {
	if(cm.getzb() >= 7000) {
            cm.setzb(-7000);
cm.serverNotice("『绯红骑士团公告』：【"+ cm.getChar().getName() +"】带领他的队友开始挑战绯红骑士团【吉米】！"); 
        cm.summonMob(9500356, 10000000, 200000, 1);吉米
        }else{
        cm.sendOk("抱歉你没有7000元宝。我不能为您召唤"); 
	cm.dispose();}
} else if (selection == 1) {

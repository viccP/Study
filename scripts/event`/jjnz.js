...
var yp = Array(10,2,3,4,4,3,4,5,14,1); 
...
function setup(eim, leaderid) {
    ...
    var mob = em.getMonster(8500002);//
    var overrideStats = Packages.server.life.OverrideMonsterStats();
    //var hprand = Math.floor(Math.random() * 5100000000)+10000000000;
    overrideStats.setOHp(1000000000);
...
function allMonstersDead(eim) {
		...
		map.spawnAutoDrop(item[randitem],chr.getPosition());
                map.broadcastMessage(Packages.tools.MaplePacketCreator.serverNotice(5, "恭喜，干掉进阶闹钟，获得了" + yp[randyp] + "个正义币和一些物品奖励"));
            }
        }
    }

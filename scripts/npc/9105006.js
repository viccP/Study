...
function action(mode, type, selection) {
    ...
    if (status == 0) {
        cm.sendSimple("我是美发店老板娜塔丽。只要你有皇家理发劵#v5150040#，就把头发交给我吧。选择你想做的事情吧。\r\n#b#L0#更换发型(使用皇家理发劵#v5150040#)#l\r\n#L1#染色(使用高级会员卡#v5151001#)#l");
    } else if (status == 1) {
        if (selection == 0) {
            ...
            cm.askAvatar("我可以帮你换成全新的发型。你厌倦了现在的发型了吗？只要你有皇家理发劵#v5150040#，我就可以帮你更换发型。请慢慢挑选自己喜欢的发型～", 5150040, hair_Colo_new);
        } else if (selection == 1) {
            ...
            cm.askAvatar("我们可以为你改变头发的颜色。是不是已经厌倦了头发的颜色啊？如果你有皇家理发劵#v5151001#，我就可以给你染发，慢慢挑选你喜欢的颜色吧！", 5151001, hair_Colo_new);
        }
    } else if (status == 2) {
        if (beauty == 1) {

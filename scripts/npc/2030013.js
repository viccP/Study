        ...
        case 10:
            if (selection == 0) {
                ...
                if (cm.getSquad("ChaosZak") != null) {
                    ...
                    dd.startInstance(cm.getSquad("ChaosZak"), cm.getMap(), "进阶扎昆",false);
                    cm.dispose();
                } else {
                    cm.sendOk("由于未知的错误，操作失败。");
                    cm.safeDispose();
        ...
        case 10:
            if (selection == 0) {
                ...
                if (cm.getSquad("ZAK") != null) {
					...
					cm.getPlayer().setbosslog(2);//BOSS重返
					
                    //dd.startInstance(cm.getSquad("ZAK"), cm.getMap(), "普通扎昆");
                    cm.dispose();
                } else {
                    cm.sendOk("由于未知的错误，操作失败。");
                    cm.safeDispose();

...
var belt_level = Array(25, 70, 90, 120, 120, 120, 120, 90);
var belt_points = Array(200, 1800, 3000, 6000, 10000, 8000, 10000, 10000);
...
function start() {
    ...
    if (mapid == 925020001) {
        ...
        cm.sendYesNo("什么？你已经准备好放弃了吗？你只需要继续前进到下一个水平。你确定要退出吗？");
    }
}
    ...
    if (mapid == 925020001) {
        ...
        if (status == 0) {
            ...
            if (sel == 0) {
                ...
                cm.askAcceptDecline("你想离开吗？你确定你要离开？");
            } else if (sel == 2) {
                if (cm.getParty() == null) {

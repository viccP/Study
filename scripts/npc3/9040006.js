                                ...
                                if (currentCombo == null || currentCombo.equals("reset")) {
                                        ...
                                        if (guess != null) {
                                                if (combo == guess) {
                                                        ...
                                                        var black = net.sf.cherry.server.life.MapleLifeFactory.getMonster(9300036);
									  black.disableDrops();
                                                        var myst = net.sf.cherry.server.life.MapleLifeFactory.getMonster(9300037);
									  myst.disableDrops();
                                                        if (attempt < 7) {
                                                                ...
                                                                for (var i = 0; i < 5; i++) {
                                                                        ...
                                                                        black = net.sf.cherry.server.life.MapleLifeFactory.getMonster(9300036);
												black.disableDrops();
                                                                        myst = net.sf.cherry.server.life.MapleLifeFactory.getMonster(9300037);
												myst.disableDrops();

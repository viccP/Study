...
function action(mode, type, selection) {
        var invent = cm.getPlayer().getInventory(net.sf.cherry.client.MapleInventoryType.EQUIPPED);
	  if (invent.countById(1032033) == 1) {
		net.sf.cherry.server.MapleInventoryManipulator.drop(cm.getPlayer().getClient(), null, invent.findById(1032033).getPosition(), 1);
	  }
